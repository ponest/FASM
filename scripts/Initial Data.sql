...
INSERT INTO Permissions VALUES('Setups-IndexCategories','View Categories','Setups'),('Setups-CreateCategory','Create New Category','Setups'),('Setups-EditCategory','Edit Category','Setups'),
('Setups-DeleteCategory','Delete Categories','Setups'),('Accounts-Index','Site Index Page','Accounts'),('Accounts-Logout','Logout','Accounts'),
('Accounts-Register','Register','Accounts'),('Setups-IndexLocation','Index Location','Setups'),('Setups-CreateLocation','Create Location','Setups'),
('Setups-EditLocation','Edit Location','Setups'),('Setups-DeleteLocation','Delete Location','Setups'),('Setups-IndexDistrict','Index District','Setups'),('Setups-CreateDistrict','Create District','Setups'),
('Setups-LoadEditDistrict','Load edit district popup form','Setups'),('Setups-PostEditDistrict','Edit District','Setups'),('Setups-DeleteDistricts','Delete Districts','Setups'),('Accounts-Permission','Viewing Permissions','Accounts'),('Accounts-IndexUsers','Users index page','Accounts'),
('Accounts-CreateUsers','Create Users','Accounts'),('Accounts-EditUsers','Edit Users','Accounts'),('Accounts-DeleteUsers','Delete Users','Accounts'),('Accounts-IndexRoles','Index Roles','Accounts'),('Accounts-CreateRoles','Create Roles','Accounts'),
